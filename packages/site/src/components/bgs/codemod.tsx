...
export default function Codemod() {
  return (
    <>
      <div className="mx-auto flex w-full max-w-[1312px] items-center justify-between px-m py-s transition-all duration-300 ease-out lg:px-xxxl lg:py-[20px] z-0">
        <svg
          width="133"
          height="22"
          viewBox="0 0 133 22"
        ...
        >
          <g clip-path="url(#clip0_2887_5290)">
            <mask
              id="mask0_2887_5290"
              ...
              height="22"
            >
              <rect width="132.71" height="21.8986" fill="#D9D9D9"></rect>
            </mask>
          ...
          <defs>
            <clipPath id="clip0_2887_5290">
              <rect width="132.713" height="22" fill="white"></rect>
            </clipPath>
          </defs>
        </svg>
      </div>
